...
//Cannot use Temporal directly because bundling causes issues with the polyfill, so we store the date as a string.
export const PRIVACY_POLICY_UPDATED = '2026-08-04';
